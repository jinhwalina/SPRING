...
public class PageMaker {
	private int totalCount;// 전체 컨텐츠의 수 (를 알아야 마지막 페이지 숫자를 알 수 있음)
	private int startPage;
	private int endPage;
	private boolean prev; // 이전 버튼 다음 버튼을 보일 지 말지
	private boolean next;
	private int displayPageNum = 3; // pagination에서 보여주는 페이지의 갯수 
